<template>
    ...
    <div class="mxg-footer">
      <div class="warp">
        ...
        <el-divider>维利博客 — 技术交流,成果交汇</el-divider>
        ...
        <div class="footer-information-box">
          <p>Copyright &copy;2021 weili_wang@qq.com &nbsp;All Rights Reserved&nbsp;
            <a href="http://www.beian.miit.gov.cn/" target="_blank" rel="nofollow"> 渝ICP备16666999号-77</a>
          </p>
        </div>
      </div>
